...
com.popultrade.model.TemplateList vseb = dao.getTemplateList(new Long(nul.jeNullDefault(request.getParameter("idnav"))));
...
sif = dao.getTemplateList(new Long(request.getParameter("idnav")));
...
<body  style="margin: 0"   background="podlaga.jpg" bgproperties="fixed"   >
 ...
 if (request.getParameter("akcija")==null) {
  ...
  <form name="dodi" method="post" action="m_navodila_set_li.jsp">
