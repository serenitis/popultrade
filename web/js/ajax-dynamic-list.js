...
************************************************************************************************************/
	...
	function ajax_option_setValue(e,inputObj)
	{
		...
		if (zapisi_id_v_polje=="7") {
			...
			document.getElementById(dodatna_lokacija2).value = spli[1];
			...
			//ajax_list_activeInput.value = tmpValue;
			///tmpValue=spli[0];
			document.getElementById(dodatna_lokacija).value = spli[0];
			document.getElementById(dodatna_lokacija2).value = spli[1];
			ajax_list_activeInput.value = tmpValue;
...
//alert(":"+dodatna_lokacija + ":");
evv = eval("document.dod."+dodatna_lokacija );
...
var dodatna_lokacija2="";
var dodatna_lokacija3="";

var dodatna_lokacija4="";
var dodatna_lokacija5="";

function ajax_showOptionsID(inputObj,paramToExternalFile,e,lokacija,zap_id,dodatna_lokacija_id,dodatna_lokacija_id2,dodatna_lokacija_id3,dodatna_lokacija_id4,dodatna_lokacija_id5)
{
	zapisi_id_v_polje = zap_id;
	dodatna_lokacija=dodatna_lokacija_id;
	
	if (typeof(dodatna_lokacija_id2)=='string') {
		dodatna_lokacija2 = dodatna_lokacija_id2;
	}
	else {
		dodatna_lokacija2 = "";
	...
	if (typeof(dodatna_lokacija_id3)=='string') {
		dodatna_lokacija3 = dodatna_lokacija_id3;
	}
	else {
		dodatna_lokacija3 = "";
	...
	if (typeof(dodatna_lokacija_id4)=='string') {
		dodatna_lokacija4 = dodatna_lokacija_id4;
	}
	else {
		dodatna_lokacija4 = "";
	...
	if (typeof(dodatna_lokacija_id5)=='string') {
		dodatna_lokacija5 = dodatna_lokacija_id5;
	}
	else {
		dodatna_lokacija5 = "";
	...
	ajax_showOptions(inputObj,paramToExternalFile,e,lokacija);
	...
	function ajax_showOptions(inputObj,paramToExternalFile,e,lokacija)
	{
		//alert(e.keyCode);
