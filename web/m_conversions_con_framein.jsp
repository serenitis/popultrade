...
<iframe noresize="noresize"  id="ifr2" name="prvain" target="drugain"  scrolling="yes" frameborder="0"   src="m_templatexml_list.jsp?idg=<%=request.getParameter("idg") %>"   style="width:100%;height:100%"  >b</iframe>
        </div>
