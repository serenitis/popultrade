...
<form name=dod action="m_templateclass_class_vrednosti_hint.jsp" method="post" onSubmit="return check()">
...
com.popultrade.dao.TemplateClassClassDAO daoth = (com.popultrade.dao.TemplateClassClassDAO)contextUtil.getBeanDao("templateClassClassDAO",pageContext.getServletContext());
					...
					//List li = templateUtil.getClassMetodeImenaSPodclasami(contextUtil,this.getServletContext(),"com.popultrade.model."+thead.getClass_name(),"get",3);
					...
					<option value="sifra" <%=nul.jeNull(vseb.getTip()).equals("sifra")?"selected":""%>>Sifra hinta (npr. cifra statusa)</option>
					<option value="vrednost" <%=nul.jeNull(vseb.getTip()).equals("vrednost")?"selected":""%>>Vrednost hinta (ko gres z misko gor)</option>
					</select>
            		 </td>
