...
vseb.setPdf_header(nul.jeNull(request.getParameter("xml_header")).equals("1")?"1":"0");
...
<form name=dod action="m_templateview_xml_edit.jsp" method="post" onSubmit="return check()">
