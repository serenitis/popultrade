...
<title>New Page 1</title>
  ...
  <frameset cols="50%,50%">
    <frame name="a1" src="m_upload_1.jsp?sifra=<%=request.getParameter("sifra")%>&sifraor=null&stsl=22&back=&fram=1&prikazi=<%=nul.jeNull(request.getParameter("prikazi")).equals("")?"10":nul.jeNull(request.getParameter("prikazi")) %>"  scrolling="yes" style="border-style: solid; border-width: 1" >
