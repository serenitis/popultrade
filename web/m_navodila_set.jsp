...
com.popultrade.model.TemplateUi vseb = dao.getTemplateUi(new Long(nul.jeNullDefault(request.getParameter("idnav"))));
...
sif = dao.getTemplateUi(new Long(request.getParameter("idnav")));
...
<body  style="margin: 0"   background="podlaga.jpg" bgproperties="fixed"   >
 ...
 if (request.getParameter("akcija")==null) {
  ...
  <form name="dodi" method="post" action="m_navodila_set.jsp">
