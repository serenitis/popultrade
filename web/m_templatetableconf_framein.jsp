...
<iframe noresize="noresize"  id="ifr2" name="prvain" target="drugain"  scrolling="yes" frameborder="0"   src="m_templatetableconf.jsp?id_nad=<%=request.getParameter("id_nad") %>&tablename=<%=request.getParameter("tablename")%>&modelname=<%=request.getParameter("modelname")%>&idg=<%=request.getParameter("idg") %>"   style="width:100%;height:100%"  >b</iframe>
        </div>

            <div  style="background-image:url('podlaga.jpg');">


<iframe noresize="noresize" id="ifr3" name="drugain" target="prvain" src="m_templatetableconfb.jsp?id_nad=<%=request.getParameter("id_nad") %>&tablename=<%=request.getParameter("tablename")%>&modelname=<%=request.getParameter("modelname")%>&idg=<%=request.getParameter("idg") %>" scrolling="yes" frameborder="0" style="width:100%;height:100%"  onload="collapseL(this.contentWindow.location)"  >b</iframe>
