...
String rezu_format="";
if (modx!=null) {
	List vsee = modx.getResults();
	
	System.out.println("IS QUESTION  "+vsee.size());
	for (int i=0;i<vsee.size();i++) {
	com.popultrade.model.Results modc = (com.popultrade.model.Results)vsee.get(i);
	
	result.append("<option value='"+nul.jeNull(modc.getId())+"'>"+nul.jeNull(modc.getResult())+"</option>");
