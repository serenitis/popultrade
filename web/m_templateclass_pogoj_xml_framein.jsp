...
<html>
 ...
 <frameset cols="35%,65%" framespacing="0" border="<%=size%>" frameborder="<%=size%>">
  <frame name="prvain" target="drugain"  marginheight="1"  scrolling="<%=scrol %>"   src="m_templateclass_pogoj_xml.jsp?idt=<%=request.getParameter("idt") %>&idg=<%=request.getParameter("idg") %>&sifid=<%=request.getParameter("sifid") %>"   style="border-style: solid; border-width: 1">
