...
<form name=dod action="m_templatepdfparametri_edit.jsp" method="post" onSubmit="return check()">
...
<table border="0" cellspacing="1" style=" font-family:Verdana; font-size:8pt"  width="100%" onload="mom()" ><tr><td colspan="4" class="opiscell">&nbsp;</td></tr>
            		 ...
            		 <td class="opiscell" width="20%">Pdf font size: </td><td class="valuecell" width="30%">
            		 ...
            		 <input type="text" name="pdf_font_size" maxlength='5' size='5' value="<%=nul.jeNull(vseb.getPdf_font_size()+"")%>" style="font-family: Verdana; font-size: 8pt">
             		 ...
             		 <td class="opiscell" width="20%">Pdf font size prevod: </td><td class="valuecell" width="30%">
            		 
            		 <input type="text" name="pdf_font_size_prevod" maxlength='5' size='5' value="<%=nul.jeNull(vseb.getPdf_font_size_prevod()+"")%>" style="font-family: Verdana; font-size: 8pt">
            		 ...
            		 <td class="opiscell" width="20%">Pdf font debelina (bold): </td><td class="valuecell" width="30%">
   <input type="checkbox" name="pdf_font_width" value="1" <%=nul.jeNull(vseb.getPdf_font_width()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
				          		 
            		
            		 
            		 </td>
            		 
             		 <td class="opiscell" width="20%">Pdf font debelina prevod (bold): </td><td class="valuecell" width="30%">
            	   <input type="checkbox" name="pdf_font_size_prevod_width" value="1" <%=nul.jeNull(vseb.getPdf_font_size_prevod_width()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
       		  ...
       		  <tr>
            		 ...
            		 <td class="opiscell" width="20%">Pdf sirina polja: </td><td class="valuecell" width="30%">
            		 
            		 <input type="text" name="pdf_cell_width_value" maxlength='5' size='5' value="<%=nul.jeNull(vseb.getPdf_cell_width_value()+"")%>" style="font-family: Verdana; font-size: 8pt">
            		 
            		 
            		 </td>
            		 
             		 <td class="opiscell" width="20%">Pdf sirina polja prevod: </td><td class="valuecell" width="30%">
            		 
            		 <input type="text" name="pdf_cell_width_prevod" maxlength='5' size='5' value="<%=nul.jeNull(vseb.getPdf_cell_width_prevod()+"")%>" style="font-family: Verdana; font-size: 8pt">
       		  ...
       		  <tr>
            		 ...
            		 <td class="opiscell" width="20%">Pdf header font size: </td><td class="valuecell" width="30%">
            		 
            		 <input type="text" name="pdf_header_font_size" maxlength='5' size='5' value="<%=nul.jeNull(vseb.getPdf_header_font_size()+"")%>" style="font-family: Verdana; font-size: 8pt">
            		 
            		 
            		 </td>
            		 
             		 <td class="opiscell" width="20%">Pdf debelina fonta (bold): </td><td class="valuecell" width="30%">
            		    <input type="checkbox" name="pdf_header_width" value="1" <%=nul.jeNull(vseb.getPdf_header_width()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
       		  ...
       		  <tr>
            		 ...
            		 <td class="opiscell" width="20%">Uporabi page break (vsak nov zapis skoci na novo stran): </td><td class="valuecell" width="30%">
            		 
            		<input type="checkbox" name="uporabi_page_break" value="1" <%=nul.jeNull(vseb.getUporabi_page_break()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
		 
            		 
            		 </td>
            		 
             		 <td class="opiscell" width="20%">Barva ozadja za prevod:</td><td class="valuecell" width="30%">
