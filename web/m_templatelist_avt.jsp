...
System.out.println("ZZZZZZZZZZZZZZZZZZ 13");
...
/*alert(document.getElementById("SI_getProblem_desc").value);
...
<form name=dod action="m_templatelist_avt.jsp" method="post" onsubmit="return chek()" >
