...
<form name=dod action="m_templateclass_pogoj_edit2.jsp" method="post" onSubmit="return check()">
...
<table border="0" cellspacing="1" style=" font-family:Verdana; font-size:8pt"  width="100%" onload="mom()" ><tr><td colspan="4" class="opiscell">&nbsp;</td></tr>
			...
			<option value="IF" <%=nul.jeNull(vseb.getPredpona_pogoja()).equals("IF")?"selected":""%>>IF</option>
				<option value="ELSE IF" <%=nul.jeNull(vseb.getPredpona_pogoja()).equals("ELSE IF")?"selected":""%>>ELSE IF</option>	
					...
					<option value="VARIABLE" <%=nul.jeNull(vseb.getPredpona_pogoja()).equals("VARIABLE")?"selected":""%>>VARIABLE</option>
            		 ...
            		 <textarea name="vrednost_pogoja" style="font-family: Verdana; font-size: 8pt" rows=3 cols=120><%=nul.jeNull(vseb.getVrednost_pogoja()+"")%></textarea>
	  ...
	  <tr id="formatme" >
            		 ...
            		 <td class="opiscell" width="20%">HQL pogoj (samo Alen): </td><td class="valuecell" width="30%" colspan="3">
            		  ...
            		  <textarea name="dodaten_hql_pogoj"  style="font-family: Verdana; font-size: 8pt" cols=100 rows=3><%=nul.jeNull(vseb.getDodaten_hql_pogoj()+"")%></textarea>
