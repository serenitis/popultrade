...
//	email :	fuushikaden@yahoo.com
	...
	var gotoString = "Select next month";
	var todayString = "Today is ";
	var weekString = "We";
	var scrollLeftMessage = "Click to select previous month. Hold button to scroll!";
	var scrollRightMessage = "Click to select next month. Hold button to scroll!";
	var selectMonthMessage = "Click to select month.";
	var selectYearMessage = "Click to select year.";
	var selectDateMessage = "Select [date] for date."; // do not replace [date], it will be replaced by date.
    ...
    */
	...
	{
		dayName = new Array	("Mon","Tue","Wen","Thu","Fri","Sat","Sun");
	}
	...
	function popUpMonth() {
		...
		crossMonthObj.left = parseInt(crossobj.left) - 20;
		crossMonthObj.top =	parseInt(crossobj.top) + 0;
	...
	function popUpYear() {
		...
		crossYearObj.top = parseInt(crossobj.top) +	16;
	}
