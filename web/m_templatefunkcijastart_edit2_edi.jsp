...
<tr>
            		 <td class="opiscell" width="20%">Ime vrstice: </td><td class="valuecell"  colspan=3>
...
<tr>
            		 <td class="opiscell" width="20%">Class funkcije za EDI vrstico: </td><td class="valuecell"  colspan=3>
...
<tr>
            		 <td class="opiscell" width="20%">Opis vrstice v edi: </td><td class="valuecell"  colspan=3>
