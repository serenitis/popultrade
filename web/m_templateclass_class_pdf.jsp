...
document.location = "m_templateclass_class_pdf.jsp?kaj=insert&idm=<%=sif.getId()%>&sifid=<%=sifid%>&class="+document.getElementById("class_name").value;
...
<tr   class="<%=colors[0]%>" >
 ...
 <a onClick="return vprasaj()" href="m_templateclass_class_pdf.jsp?idp=<%=request.getParameter("idp")%>&akcija=DELETE&idd=<%=sif.getId()%>&sifid=<%=sifid%>&kaj=isto"><img src="x.gif" border=0 title="Odstrani classo"></a>
...
while (iter.hasNext()) {
	...
	<td>
	 ...
	 <a href="Javascript:PGAPP()" onCLick="return godown('m_templateclass_edit2_pdf.jsp?idp=<%=request.getParameter("idp")%>&id=<%=temc.getId()%>&idtc=<%=sif.getId()%>&sifid=<%=sifid%>&opcija=spremeni&siframm=new&idback=<%=temc.getId()%>')"><img src="u.gif" border=0  title="Spremeni podatke"></a>
	 <a onClick="return vprasaj()" href="m_templateclass_class_pdf.jsp?idp=<%=request.getParameter("idp")%>&akcija=DELETE&idd=<%=temc.getId()%>&sifid=<%=sifid%>&kaj=pogoji"><img src="x.gif" border=0 title="Brisi"></a>
...
<a onClick="return godown('m_templateclass_edit2_pdf.jsp?idp=<%=request.getParameter("idp")%>&opcija=new&siframm=new&sifrant=null&sifid=<%=sifid%>&idtc=<%=sif.getId()%>')" href="Javascript: PGAPP()"><img title="Dodaj novi pogoj" border="0" src="vnos.gif" /></a>
...
while (iter.hasNext()) {
	...
	<%=nul.jeNull(temc.getVrednost())%></td><td>
	 ...
	 <a onClick="return vprasaj()" href="m_templateclass_class_pdf.jsp?idp=<%=request.getParameter("idp")%>&akcija=DELETE&idd=<%=temc.getId()%>&sifid=<%=sifid%>&kaj=vrednosti"><img src="x.gif" border=0 title="Brisi"></a>
