...
<html>
 ...
 <frameset rows="50%,50%" framespacing="0" border="<%=size%>" frameborder="<%=size%>">
  <frame name="prvain" target="drugain"  marginheight="1"  scrolling="<%=scrol %>"   src="<%=request.getParameter("loka").replaceAll("QUE","?").replaceAll("AND","&")%>"   style="border-style: solid; border-width: 1">
