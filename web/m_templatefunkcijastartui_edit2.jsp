...
<form name=dod action="m_templatefunkcijastartui_edit2.jsp" method="post" onSubmit="return check()">
...
<tr>
            		 <td class="opiscell" width="20%">Ime funkcije: </td><td class="valuecell"  colspan=3>
...
<tr>
            		 <td class="opiscell" width="20%">Classa funkcije: </td><td class="valuecell"  colspan=3>
...
<tr>
            		 <td class="opiscell" width="20%">Opis funkcije: </td><td class="valuecell"  colspan=3>
...
<tr>
            		 <td class="opiscell" width="20%">Predpogoj (le request.getParameter('ime parametra')), opis v celoti z predpogojem in oklepaji: </td><td class="valuecell"  colspan=3>
            		  <input type="text" size="100" name="predpogoj" maxlength='150' value="<%=nul.jeNull(vseb.getPredpogoj()+"")%>" style="font-family: Verdana; font-size: 8pt">
