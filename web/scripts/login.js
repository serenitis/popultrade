<script type="text/javascript">
    ...
    function required () { 
        ...
        this.ab = new Array("j_password", "<fmt:message key="errors.requiredField"><fmt:param><fmt:message key="label.username"/></fmt:param></fmt:message>", new Function ("varName", " return this[varName];"));
    } 
</script>