...
public String narediEmbeddable(com.popultrade.webapp.chkNull nul,com.popultrade.webapp.control control,com.popultrade.model.TemplateTables vseb,Hashtable nosql) {
...
if ((nul.jeN(vseb.getTable_type()).equals("1"))) {
	...
	while (itc.hasNext()) {
		...
		criteriaa.append("}\r\n");
			...
			sbc.append("@OneToMany(fetch=FetchType.LAZY,targetEntity=com.popultrade.model."+vsebc.getH_connection_table()+".class,cascade = CascadeType.REMOVE)\r\n");
			sbc.append("@JoinColumn(name=\""+vsebc.getH_connection_column()+"\""+proref+")\r\n");
			...
			sbc.append("@ManyToOne(fetch=FetchType.LAZY,targetEntity=com.popultrade.model."+vsebc.getH_connection_table()+".class)\r\n");
			...
			sbc.append("@OneToOne(cascade = CascadeType."+vsebc.getH_connection_cascade()+",fetch=FetchType.LAZY,mappedBy=\""+vsebc.getH_mapped_by()+"\")\r\n");
			sbc.append("@NotFound(action = NotFoundAction.IGNORE)\r\n");
			...
			if (onetoone.containsKey(imefile)) {
				...
				Hashtable hk = (Hashtable)onetoone.get(imefile);
				hk.put(stej+"", reverse);
				onetoone.put(imefile, hk);
...
sbx.append(narediEmbeddable(nul,control,ttab,nosql));
      ...
      ///////////////////////////////////////
       ...
       if ((nul.jeN(vseb.getTable_type()).equals("1"))) {
    	  ...
    	  //  String imecl = (vseb.getTable_name_hibernate().substring(0,1).toUpperCase()+vseb.getTable_name_hibernate().substring(1));
    	    ...
    	    daoo.append("package com.popultrade.model.dao;\r\n");
    	    ...
    	    daoo.append("import com.popultrade.model.LogAll;\r\n");
    	    	...
    	    	daoo.append("public "+imecl+" get"+imecl+"(String id,EntityManagerFactory emm) {\r\n");
    	    		...
    	    		daoo.append("public boolean save"+imecl+"("+imecl+" la,EntityManagerFactory emm) {\r\n");
    	    			...
    	    			daoo.append("public void remove"+imecl+"(String id,EntityManagerFactory emm) {\r\n");
    	    				...
    	    				daoo.append("LogAll la = this.getLogAll(id, emm);\r\n");
...
daoo.append("Example ex = Example.create("+imecl.toLowerCase()+").ignoreCase().excludeZeroes().enableLike(MatchMode.START);   \r\n");  
...
while (en.hasMoreElements()) {
	...
	String celfile = "";
	 FileInputStream stream = new FileInputStream(control.hibernate_classes+key);
        ...
        output.write((String)onetoone.get(key)+"\r\n");
        output.write("}\r\n");
        output.close();
      } catch ( IOException e ) {
         e.printStackTrace();
