...
<form name=dod action="m_templatefunkcija_pogoj_edit22.jsp" method="post" onSubmit="return check()">
			...
			<option value="IF" <%=nul.jeNull(vseb.getPredpona_pogoja()).equals("IF")?"selected":""%>>IF</option>
				<option value="ELSE IF" <%=nul.jeNull(vseb.getPredpona_pogoja()).equals("ELSE IF")?"selected":""%>>ELSE IF</option>	
					...
					<option value="FORMAT" <%=nul.jeNull(vseb.getPredpona_pogoja()).equals("FORMAT")?"selected":""%>>SAMO FORMAT</option>	
            		 ...
            		 <textarea name="vrednost_pogoja" rows="1" cols="150" style="font-family: Verdana; font-size: 8pt"><%=nul.jeNull(vseb.getVrednost_pogoja()+"")%></textarea>
	...
	<%
					...
					<input type="text" name="hv3" maxlength='100' size="20" value="" style="font-family: Verdana; font-size: 8pt">
            		 <input type="button" value="V VREDNOST" onclick="dodajv()" style="font-family: Verdana; font-size: 8pt">
            		  	 ...
            		  	 <tr>
            		 <td class="opiscell" width="20%">Rocna vrednost (rocna vrednost, se prepise isto, po vrednost pogoja): </td><td class="valuecell" width="30%" colspan=3>
            		 
            		 
            		 <textarea name="rocna_vrednost" rows="4" cols="90" style="font-family: Verdana; font-size: 8pt"><%=nul.jeNull(vseb.getRocna_vrednost()+"")%></textarea>
            		 ...
            		 <td class="opiscell" width="20%">Uporabi prevod kot rezultat (tudi vrednost pogoja mora biti vnesena): </td><td class="valuecell" width="30%" >
