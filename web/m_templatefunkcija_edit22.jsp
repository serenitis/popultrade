...
<form name=dod action="m_templatefunkcija_edit22.jsp" method="post" onSubmit="return check()">
...
<table border="0" cellspacing="1" style=" font-family:Verdana; font-size:8pt"  width="100%" onload="mom()" ><tr><td colspan="4" class="opiscell">&nbsp;</td></tr>
			...
			if (true) {
					...
					%>
            		 ...
            		 <td class="opiscell" width="20%">Vrednost pogoja (v primeru, da je vec vrednosti oz. gre preko checkboxa se vnese request.getParameter(vrednost_checkbox)): </td><td class="valuecell" width="30%">
            		 <textarea cols="70" rows=2 name="vrednost_pogoja"  style="font-family: Verdana; font-size: 8pt"><%=nul.jeNull(vseb.getVrednost_pogoja()+"")%></textarea>
	...
	<%
										...
										if (true) {
											...
											/// dodam sepogoje, ce ima gumbe
													...
													if (!nul.jeNull(thead.getVeza_gumb()+"").equals("")) {
														...
														<option value="<%=primeri%>" <%=primeri.equals(nul.jeNull(vseb.getVrednost_pogoja()))?"selected":""%>><%=primeri%> (vrednost preko gumba)</option>
				...
				//	 System.out.println("FUNKK ::: "+li.size());
					...
					while (itti.hasNext()) {
            		 ...
            		 <input type="text" size="1"  name="izvor_vrednosti" value="<%=nul.jeNull(vseb.getIzvor_vrednosti()+"")%>" readonly style="font-family: Verdana; font-size: 8pt" >
            		 </td>
					...
					&nbsp;</td>
            		 ...
            		 <td class="opiscell" width="20%">Pogoji za set metode predpona je vedno IF , ce pogoj usreza se metodo poklice in doda vrednost: </td><td class="valuecell" width="30%" colspan="3">
...
<tr>
            		 ...
            		 <td class="opiscell" width="20%">Dodatni pogoji HQL: </td><td class="valuecell" colspan=3>
            		 
            		 <input type="text" name="dodaten_pogoj_za_request" maxlength='350' size="120" value="<%=nul.jeNull(vseb.getDodaten_pogoj_za_request()+"")%>" style="font-family: Verdana; font-size: 8pt">
...
<tr>
            		 ...
            		 <td class="opiscell" width="20%">Uporabi za update lista (uporabi se v primeru, da ima list izbrano opcijo update - v bistvu kar se updata): </td><td class="valuecell" colspan=3>
