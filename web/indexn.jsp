...
sb.append("<textarea name='prevod_"+templateui.getId()+"_P_"+nul.jeNull(ConPool.getPrevod_admin_id(templateui.getId()+""))+"'  class=\""+(nul.jeNull(templateui.getDdivclasscusin()).equals("")?"":templateui.getDdivclasscusin())+"\" cols='"+(templateui.getCols()!=null?templateui.getCols():"55")+"' rows='"+(templateui.getRows()!=null?templateui.getRows():"1")+"'>"+nul.jeNull(ConPool.getPrevod_admin(templateui.getId()+"","P",session.getAttribute("jezikv")+""))+"</textarea>");
...
sb.append("<table  class=\""+(nul.jeNull(templateui.getDdivfirsttable()).equals("")?"tdefaulttable":templateui.getDdivfirsttable())+"\" ><tr><td  align='center' valign='middle'><tr><td  class=\""+(nul.jeNull(templateui.getDdivclasscusf()).equals("")?"touchbuttoninner":templateui.getDdivclasscusf())+"\" >");
...
sb.append("<input  class=\""+(nul.jeNull(templateui.getDdivclasscusin()).equals("")?"":templateui.getDdivclasscusin())+"\"  type=\"button\" value=\""+nul.jeNull(ConPool.getPrevod_admin(templateui.getId()+"","P",session.getAttribute("jezikv")+""))+"\" style=\"width:"+(nul.jeNull(templateui.getDwidth()).equals("")?"100%":templateui.getDwidth())+";height:"+(nul.jeNull(templateui.getDheight()).equals("")?"100%":templateui.getDheight())+";"+nul.jeNull(templateui.getDstyle())+(nul.jeNull(templateui.getDbarvag()).equals("")?"":"background-color:"+templateui.getDbarvag()+"")+"\"> \r\n");
 ...
 <%
  ...
  %>
       ...
       if (tmfz!=null) {
        ...
        <table  <%=(nul.jeNull(tmfz.getDimenzija_tabele_h()).equals("")?"":"height='"+tmfz.getDimenzija_tabele_h()+"'") %>  <%=(nul.jeNull(tmfz.getDimenzija_tabele()).equals("")?"":"width='"+tmfz.getDimenzija_tabele()+"'") %>    style="<%=nul.jeNull(tmfz.getDstyle())%>"   class="<%=nul.jeNull(tmfz.getDdivclasscus())%>"  >
       <%
       }
        else if (tmfz!=null) {
       %>
          <table  style="<%=nul.jeNull(tmfz.getDstyle())%>"   class="<%=nul.jeNull(tmfz.getDdivclasscus())%>">
	...
	com.popultrade.model.TemplateUi vseb = (com.popultrade.model.TemplateUi)(it.next());
     ...
     //    stelementov++;
      ...
      //	jeprvi=false;
        ...
        <td valign=top <%=colspano %>     width="<%=(nul.jeNull(vseb.getDtablewidth()).equals("")?(""+proc+"%"):vseb.getDtablewidth()+"") %>">
         <table class="<%=nul.jeNull(tmfz.getDdefaultcont())%>" >
   ...
   <tr>
	...
	while (imn.hasNext()) {
     ...
     <table cellspacing=0 cellpadding=0 border=0 width=100% height=100%  >
        ...
        <tr>
        <td  width="<%=(nul.jeNull(vsebb.getDtablewidth()).equals("")?(""+proc+"%"):vsebb.getDtablewidth()+"") %>">
	...
	while (imnb.hasNext()) {
        ...
        <tr>
        <td  width="<%=(nul.jeNull(vsebb2.getDtablewidth()).equals("")?(""+proc+"%"):vsebb2.getDtablewidth()+"") %>">
	...
	while (imnbt.hasNext()) {
        ...
        <tr>
        <td  width="<%=(nul.jeNull(vsebb3.getDtablewidth()).equals("")?(""+proc+"%"):vsebb3.getDtablewidth()+"") %>">
...
<div>
     ...
     <table width=100% height=100% <%=(tmfl!=null && (!nul.jeNull(tmfl.getDspacing()).equals(""))?"cellspacing='"+tmfl.getDspacing()+"'":"")+" "+((tmfl!=null && !nul.jeNull(tmfl.getDpadding()).equals(""))?"cellpadding='"+tmfl.getDpadding()+"'":"")%>  style=" font-family: Verdana; font-size: 7pt"><tr><td style="vertical-align:<%=(tmfl!=null)?(nul.jeNull(tmfl.getDvalign()).equals("")?"top":tmfl.getDvalign()):"top" %>" align="<%=(tmfl!=null)?(nul.jeNull(tmfl.getDalign()).equals("")?"left":tmfl.getDalign()):"left" %>" >
       ...
       if (tmfl!=null) {
        ...
        <table  <%=(nul.jeNull(tmfl.getDimenzija_tabele_h()).equals("")?"":"height='"+tmfl.getDimenzija_tabele_h()+"'") %>  <%=(nul.jeNull(tmfl.getDimenzija_tabele()).equals("")?"":"width='"+tmfl.getDimenzija_tabele()+"'") %> style="<%=nul.jeNull(tmfl.getDstyle())%>"   class="<%=nul.jeNull(tmfl.getDdivclasscus())%>">
       <%
       }
         else if (tmfl!=null) {
       %>
          <table   style="<%=nul.jeNull(tmfl.getDstyle())%>"   class="<%=nul.jeNull(tmfl.getDdivclasscus())%>">
...
while (it.hasNext()){  // while start
	...
	com.popultrade.model.TemplateUi vseb = (com.popultrade.model.TemplateUi)(it.next());
      ...
      //	jeprvi=false;
        ...
        jeprvi=false;
         ...
         %>
        <td <%=colspano %> valign=top width="<%=(nul.jeNull(vseb.getDtablewidth()).equals("")?(""+proc+"%"):vseb.getDtablewidth()+"") %>">
         <table  class="<%=nul.jeNull(tmfl.getDdefaultcont())%>" >
	...
	while (imnb.hasNext()) {
        ...
        <tr>
        <td  valign=top width="<%=(nul.jeNull(vsebb2.getDtablewidth()).equals("")?(""+proc+"%"):vsebb2.getDtablewidth()+"") %>">
	...
	while (imnbt.hasNext()) {
        ...
        <tr>
        <td  valign=top width="<%=(nul.jeNull(vsebb3.getDtablewidth()).equals("")?(""+proc+"%"):vsebb3.getDtablewidth()+"") %>">
 ...
 <div id="secondNested">
       ...
       if (tmfs!=null) {
        ...
        <table <%=(nul.jeNull(tmfs.getDimenzija_tabele_h()).equals("")?"":"height='"+tmfs.getDimenzija_tabele_h()+"'") %>  <%=(nul.jeNull(tmfs.getDimenzija_tabele()).equals("")?"":"width='"+tmfs.getDimenzija_tabele()+"'") %> style="<%=nul.jeNull(tmfs.getDstyle())%>"   class="<%=nul.jeNull(tmfs.getDdivclasscus())%>">
       <%
       }
         else if (tmfs!=null) {
       %>
          <table   style="<%=nul.jeNull(tmfs.getDstyle())%>"   class="<%=nul.jeNull(tmfs.getDdivclasscus())%>">
	...
	com.popultrade.model.TemplateUi vseb = (com.popultrade.model.TemplateUi)(it.next());
      ...
      //	jeprvi=false;
        ...
        jeprvi=false;
         ...
         %>
        <td valign=top <%=colspano %> width="<%=(nul.jeNull(vseb.getDtablewidth()).equals("")?(""+proc+"%"):vseb.getDtablewidth()+"") %>">
         <table  class="<%=nul.jeNull(tmfs.getDdefaultcont())%>" >
...
<div id='rightt' style="background-image:url('rightb.gif');background-repeat:no-repeat;background-position: center center;">
       ...
       if (tmfd!=null && tmfd.getId()!=null) {
        ...
        <table  <%=(nul.jeNull(tmfd.getDimenzija_tabele_h()).equals("")?"":"height='"+tmfd.getDimenzija_tabele_h()+"'") %>  <%=(nul.jeNull(tmfd.getDimenzija_tabele()).equals("")?"":"width='"+tmfd.getDimenzija_tabele()+"'") %> style="<%=nul.jeNull(tmfd.getDstyle())%>"   class="<%=nul.jeNull(tmfd.getDdivclasscus())%>">
       <%
       }
       else if (tmfd!=null) {
       %>
          <table  style="<%=nul.jeNull(tmfd.getDstyle())%>"   class="<%=nul.jeNull(tmfd.getDdivclasscus())%>">
	...
	com.popultrade.model.TemplateUi vseb = (com.popultrade.model.TemplateUi)(it.next());
      ...
      //	jeprvi=false;
        ...
        jeprvi=false;
         ...
         %>
        <td valign=top <%=colspano %> width="<%=(nul.jeNull(vseb.getDtablewidth()).equals("")?(""+proc+"%"):vseb.getDtablewidth()+"") %>">
         <table  class="<%=nul.jeNull(tmfd.getDdefaultcont())%>" >
