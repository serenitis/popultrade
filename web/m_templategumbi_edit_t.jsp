...
<form name=dod action="m_templategumbi_edit_t.jsp" method="post" onSubmit="return check()">
  	...
  	%>
		  ...
		  <tr>
            		 ...
            		 <td class="opiscell" width="20%"></td><td class="valuecell" width="30%">
             		 ...
             		 <td class="opiscell" width="20%">Funkcija ki klicem ce je oznacen uporabi alert, ce ni vrednosti se klice default prompt (za uporabo prevoda dodas [ALERT] v funkcijo): </td><td class="valuecell" width="30%">
...
<tr>
	 <td class="opiscell">Vrednosti preko checkboxa (ce gre za vrednosti pridobljene preko checkboxa): </td><td class="valuecell" colspan=3>
	...
	<br>
	Specificirat je potrebno na parametrih katera vrednost je pridobljena preko checkbox (stolpec metoda). Gumb mora biti v hint vrstici!
...
<option value="copyplav.gif" <%=nul.jeNull(vseb.getZamenjaj_url_gumba()).equals("copyplav.gif")?"selected":""%>>Copy play</option>
         ...
         <tr>
            		 ...
            		 <textarea cols="100" rows="1" name="rocni_url" style="font-family: Verdana; font-size: 8pt"><%=nul.jeNull(vseb.getRocni_url()+"")%></textarea>
