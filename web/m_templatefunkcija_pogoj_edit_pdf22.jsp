...
vseb.setUporabi_kot_neznanka(nul.jeNull(request.getParameter("uporabi_kot_neznanka")).equals("1")?"1":"0");
vseb.setUporabi_kot_rezultat(nul.jeNull(request.getParameter("uporabi_kot_rezultat")).equals("1")?"1":"0");
...
<form name=dod action="m_templatefunkcija_pogoj_edit_pdf22.jsp" method="post" onSubmit="return check()">
...
<table border="0" cellspacing="1" style=" font-family:Verdana; font-size:8pt"  width="100%" onload="mom()" ><tr><td colspan="4" class="opiscell">&nbsp;</td></tr>
	  <tr>
            		 ...
            		 <input type="text" name="ime_pogoja" maxlength='30' size=30 value="<%=nul.jeNull(vseb.getIme_pogoja()+"")%>" style="font-family: Verdana; font-size: 8pt">
				...
				<option value="ELSE IF" <%=nul.jeNull(vseb.getPredpona_pogoja()).equals("ELSE IF")?"selected":""%>>ELSE IF</option>	
					...
					<option value="FORMAT" <%=nul.jeNull(vseb.getPredpona_pogoja()).equals("FORMAT")?"selected":""%>>SAMO FORMAT</option>	
            		 ...
            		 <td class="opiscell" width="20%">Vrednost pogoja: </td><td class="valuecell" width="30%" colspan=3>
            		   ...
            		   <textarea rows=1 cols=150 name="vrednost_pogoja"  style="font-family: Verdana; font-size: 8pt"><%=nul.jeNull(vseb.getVrednost_pogoja()+"")%></textarea> 
            		   
            		 
            		      <br>       		 Uporabi celotno vrednost kot rezultat (dam rezultat kot je vnesen v vrednost):
            		  <input type="checkbox" name="uporabi_kot_rezultat" value="1" <%=nul.jeNull(vseb.getUporabi_kot_rezultat()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
    <br>
                		Definiraj neznanko z vrednostjo (primer String neznanka=<ime metode>;):
            		  <input type="checkbox" name="uporabi_kot_neznanka" value="1" <%=nul.jeNull(vseb.getUporabi_kot_neznanka()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
 <br>
...
<tr>
<td class="opiscell" width="20%">Zamenjaj parenta, v primeru da hoces dati ta child drugemu parentu (samo Alen): </td><td class="valuecell" width="30%" colspan="3">
            		 
<input type="text" readOnly="true" name="templatehead_id" maxlength='12' size="12" value="<%=nul.jeNull(vseb.getTemplatehead_id()+"")%>" style="font-family: Verdana; font-size: 8pt">
<input type="checkbox" onclick="(document.dod.templatehead_id.readOnly==true?document.dod.templatehead_id.readOnly=false:document.dod.templatehead_id.readOnly=true)">
</td></tr>            		
