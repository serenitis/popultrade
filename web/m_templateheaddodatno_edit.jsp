...
<tr>
            		 ...
            		 <td class="opiscell" width="20%">Dodatno java pred izvedbo procedure oz. glavne kode:&nbsp;</td><td class="valuecell" width="30%"><textarea name="dodatno_java_rocno" style="font-family: Verdana; font-size: 8pt; width: 1013px; height: 374px;"><%=nul.jeNull(vseb.getDodatno_java_rocno()+"")%></textarea></td>
