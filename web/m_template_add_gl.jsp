...
session.setAttribute("odpriprej",request.getParameter("idgumb"));
...
boolean dddd = true;
if (vseb.getSogumbi()!=null && vseb.getSogumbi()>0 && dddd) {
...
com.popultrade.dao.TemplateHeadDAO dao22 = (com.popultrade.dao.TemplateHeadDAO)contextUtil.getBeanDao("templateHeadDAO",pageContext.getServletContext());

List tmpl = dao22.getTemplateHeadImaGumb(tg.getId()+"");
boolean jeze = false;
...
if (thh.getSogumbi()!=null && thh.getSogumbi()>0) {
	sogumbi=true;
}
}
%>
...
if (jeze) {
//if (tg.getTemplateClass().get
		
	%>
	 <a href="Javascript:PGAPP()" onCLick="return go('<%=thh.getId()%>&opcija=spremeni&siframm=new&idtg=<%=tg.getId()%>',1)"><img src="u.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Spremeni podatke"></a>
	 <%
	 ...
	 %>
	 <a href="Javascript:PGAPP()" onCLick="return godown('m_generiraj_pdf.jsp?id=<%=thh.getId()%>&opcija=spremeni&siframm=new&idback=<%=thh.getId()%>&sifrant=<%=request.getParameter("sifrant")%>',1)"><img src="gen.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Generiraj jsp-je"></a>
	
	<%
	 }
 	 else if (thh.getHead_tip().equals("EX") || thh.getHead_tip().equals("EE")) {
		 %>
		 <a href="Javascript:PGAPP()" onCLick="return godown('m_generiraj_exp.jsp?id=<%=thh.getId()%>&opcija=spremeni&siframm=new&idback=<%=thh.getId()%>&sifrant=<%=request.getParameter("sifrant")%>',1)"><img src="gen.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Generiraj jsp-je"></a>
		
		<%
		 }
 	 else if (thh.getHead_tip().equals("PR") || thh.getHead_tip().equals("FU") || thh.getHead_tip().equals("OB") ) {
 		 %>
 		 <a href="Javascript:PGAPP()" onCLick="return godown('m_generiraj_jsp_pr.jsp?id=<%=thh.getId()%>&opcija=spremeni&siframm=new&idback=<%=thh.getId()%>&sifrant=<%=request.getParameter("sifrant")%>',1)"><img src="gen.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Generiraj jsp-je"></a>
 		
 		<% 
 	 } 
 	   else if (thh.getHead_tip().equals("LT") || thh.getHead_tip().equals("HT") ) {
	 %>
	 <a href="Javascript:PGAPP()" onCLick="return godown('m_generiraj_jsp_to.jsp?id=<%=thh.getId()%>&opcija=spremeni&siframm=new&idback=<%=thh.getId()%>&sifrant=<%=request.getParameter("sifrant")%>',1)"><img src="gen.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Generiraj jsp-je"></a>
	...
	<% 
 			 ...
 			 %>
 			 <a href="Javascript:PGAPP()" onCLick="return godown('m_generiraj_jsp_li.jsp?id=<%=thh.getId()%>&opcija=spremeni&siframm=new&idback=<%=thh.getId()%>&sifrant=<%=request.getParameter("sifrant")%>',1)"><img src="gen.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Generiraj jsp-je"></a>
 			
 			<% 
 		 }
	 else {
		 %>
		 <a href="Javascript:PGAPP()" onCLick="return godown('m_generiraj_jsp.jsp?id=<%=thh.getId()%>&opcija=spremeni&siframm=new&idback=<%=thh.getId()%>&sifrant=<%=request.getParameter("sifrant")%>',1)"><img src="gen.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Generiraj jsp-je"></a>
...
//if (tg.getTemplateClass().get
	...
	%>
	 <a href="Javascript:PGAPP()" onCLick="return go('<%=thh.getId()%>&opcija=spremeni&siframm=new&idtg=<%=trui.getId()%>',1)"><img src="u.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Spremeni podatke"></a>
	 <%
	 if (thh.getHead_tip().equals("PD") || thh.getHead_tip().equals("UP") || thh.getHead_tip().equals("UR") || thh.getHead_tip().equals("SE") || thh.getHead_tip().equals("HE")) {
	 %>
	 <a href="Javascript:PGAPP()" onCLick="return godown('m_generiraj_pdf.jsp?id=<%=thh.getId()%>&opcija=spremeni&siframm=new&idback=<%=thh.getId()%>&sifrant=<%=request.getParameter("sifrant")%>',1)"><img src="gen.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Generiraj jsp-je"></a>
