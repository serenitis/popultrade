...
var url="m_templatefunkcija_pdf_add2.jsp";
...
<td  align="center">
 ...
 <a href="Javascript:PGAPP()" onCLick="return go('<%=vseb.getId()%>&opcija=spremeni&siframm=new&idback=<%=vseb.getId()%>&idg=<%=session.getAttribute("idg")%>&idt=<%=session.getAttribute("idt")%>&sifid=<%=session.getAttribute("idt")%>&glavno=1',1)"><img src="u.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Spremeni podatke"></a>
		...
		<%
		if (vseb.getTemplateClassClass()!=null && vseb.getTemplateClassClass().getId()!=null  && vseb.getTemplateClassClass().getTip_funkcije()!=null && vseb.getTemplateClassClass().getTip_funkcije().equals("ER")) {
		
		%>
		
		 <a href="Javascript:PGAPP()" onCLick="return godown22('m_templateview_pdf.jspQUEidt=<%=vseb.getId()%>ANDidnn=<%=vseb.getTemplateClassClass().getId()%>ANDclassname=<%=vseb.getTemplateClassClass().getClass_name()%>')"><img src="i.gif" border=0 title="Spremeni nacin prikaza"></a>
		
		<%
		}
		else if (vseb.getTemplateClassClass()!=null && vseb.getTemplateClassClass().getId()!=null && vseb.getTemplateClassClass().getTip_funkcije()!=null && vseb.getTemplateClassClass().getTip_funkcije().equals("LI")) {
			%>
			
			 <a href="Javascript:PGAPP()" onCLick="return godown22('m_templatelist_pdf.jspQUEidt=<%=vseb.getId()%>ANDidnn=<%=vseb.getTemplateClassClass().getId()%>ANDclassname=<%=vseb.getTemplateClassClass().getClass_name()%>')"><img src="p1.gif" border=0 title="Spremeni nacin prikaza"></a>
			
			<%
			
		}
		
		else if (vseb.getTemplateClassClass()!=null && vseb.getTemplateClassClass().getId()!=null && vseb.getTemplateClassClass().getTip_funkcije()!=null && vseb.getTemplateClassClass().getTip_funkcije().equals("CO")) {
			%>
			
			 <a href="Javascript:PGAPP()" onCLick="return godown22('m_templatelist_pdf.jspQUEidt=<%=vseb.getId()%>ANDidnn=<%=vseb.getTemplateClassClass().getId()%>ANDclassname=<%=vseb.getTemplateClassClass().getClass_name()%>')"><img src="p1.gif" border=0 title="Spremeni nacin prikaza list"></a>
				 <a href="Javascript:PGAPP()" onCLick="return godown22('m_templateview_pdf.jspQUEidt=<%=vseb.getId()%>ANDidnn=<%=vseb.getTemplateClassClass().getId()%>ANDclassname=<%=vseb.getTemplateClassClass().getClass_name()%>')"><img src="i.gif" border=0 title="Spremeni nacin prikaza view"></a>
...
%>
 <a href="Javascript:PGAPP()" onCLick="return godown('m_templatefunkcija_class_framein_pdf2.jsp?idp=<%=vseb.getId()%>&classo=<%=nul.jeNull(vseb.getClass_name())%>&opcija=spremeni&siframm=new&idback=<%=vseb.getId()%>&idg=<%=session.getAttribute("idg")%>&sifid=<%=session.getAttribute("idt")%>&idt=<%=session.getAttribute("idt")%>&glavno=1')"><img src="c.gif" border=0 onClick="kliknivSivo(this,'<%=colors[br]%>');" title="Pridobi podatek iz druge tabele"></a>
<%
//}
%>
 <a onClick="return vprasaj()" href="m_templatefunkcija_pdf2.jsp?akcija=DELETE&id=<%=vseb.getId()%>&idg=<%=session.getAttribute("idg")%>&idt=<%=session.getAttribute("idt")%>"><img src="x.gif" border=0 title="Brisi"></a>
...
while (iu.hasNext()) {
	...
	<td  class="<%=colors[br]%>" width="70%" ><%=nul.jeNull(tcv.getVrednost())%>
		...
		%>
	<a onClick="return godown('m_templatefunkcija_pogoj_edit_pdf22.jsp?idv=<%=vseb.getId()%>&opcija=new&siframm=new&sifrant=null&idt=<%=session.getAttribute("idt")%>&idg=<%=session.getAttribute("idg")%>&sifid=<%=tcv.getId()%>&vrednost=<%=tcv.getVrednost()%>')" href="Javascript: PGAPP()"><img title="Dodaj nov Pogoj" border="0" src="vnos.gif" /></a>	
		<%
		}
		%>
...
%>
			...
			<td width="40%" align="left"><%=nul.jeNull(si.getIme_pogoja())%> (<%=nul.jeNull(si.getDodaten_hql_pogoj())%>) </td>
		...
		<td  align="center">
		 ...
		 <a href="Javascript:PGAPP()" onCLick="return godown('m_templatefunkcija_pogoj_edit_pdf22.jsp?idv=<%=vseb.getId()%>&id=<%=si.getId()%>&opcija=spremeni&siframm=new&idback=<%=vseb.getId()%>&idg=<%=session.getAttribute("idg")%>&idt=<%=session.getAttribute("idt")%>&sifid=<%=session.getAttribute("idt")%>&glavno=2&vrednost=<%=tcv.getVrednost()%>',1)"><img src="u.gif" border=0 title="Spremeni podatke"></a>
		
		<%
		if (si.getTemplateClassClass()!=null && si.getTemplateClassClass().getId()!=null  && vseb.getTemplateClassClass().getTip_funkcije()!=null && nul.jeNull(si.getTemplateClassClass().getTip_funkcije()).equals("ER")) {
		
		%>
		
		 <a href="Javascript:PGAPP()" onCLick="return godown22('m_templateview_pdf.jspQUEidt=<%=si.getTemplateClassClass().getId()%>ANDidnn=<%=vseb.getId()%>ANDclassname=<%=si.getTemplateClassClass().getClass_name()%>')"><img src="i.gif" border=0 title="Spremeni nacin prikaza"></a>
		
		<%
		}
		else if (si.getTemplateClassClass()!=null && si.getTemplateClassClass().getId()!=null && vseb.getTemplateClassClass().getTip_funkcije()!=null && nul.jeNull(si.getTemplateClassClass().getTip_funkcije()).equals("LI")) {
			%>
			
			 <a href="Javascript:PGAPP()" onCLick="return godown22('m_templatelist_pdf.jspQUEidt=<%=si.getTemplateClassClass().getId()%>ANDidnn=<%=vseb.getId()%>ANDclassname=<%=si.getTemplateClassClass().getClass_name()%>')"><img src="p1.gif" border=0 title="Spremeni nacin prikaza"></a>
			
			<%
			
		}
		else if (si.getTemplateClassClass()!=null && si.getTemplateClassClass().getId()!=null && vseb.getTemplateClassClass().getTip_funkcije()!=null && nul.jeNull(si.getTemplateClassClass().getTip_funkcije()).equals("CO")) {
			%>
			
			 <a href="Javascript:PGAPP()" onCLick="return godown22('m_templatelist_pdf.jspQUEidt=<%=si.getTemplateClassClass().getId()%>ANDidnn=<%=vseb.getId()%>ANDclassname=<%=si.getTemplateClassClass().getClass_name()%>')"><img src="p1.gif" border=0 title="Spremeni nacin prikaza list"></a>
				 <a href="Javascript:PGAPP()" onCLick="return godown22('m_templateview_pdf.jspQUEidt=<%=si.getTemplateClassClass().getId()%>ANDidnn=<%=vseb.getId()%>ANDclassname=<%=si.getTemplateClassClass().getClass_name()%>')"><img src="i.gif" border=0 title="Spremeni nacin prikaza view"></a>
		...
		%>
		 <a href="Javascript:PGAPP()" onCLick="return godown('m_templatefunkcija_class_framein_pdf2.jsp?idv=<%=vseb.getId()%>&idp=<%=si.getId()%>&opcija=spremeni&siframm=new&idback=<%=si.getId()%>&idg=<%=session.getAttribute("idg")%>&sifid=<%=session.getAttribute("idt")%>&idt=<%=session.getAttribute("idt")%>&glavno=2&vrednost=<%=tcv.getVrednost()%>')"><img src="c.gif" border=0 title="Pridobi podatek iz druge tabele"></a>
		<%
		//}
		%>
		 <a onClick="return vprasaj()" href="m_templatefunkcija_pdf2.jsp?akcija=DELETE&kaj=class&id=<%=si.getId()%>&idg=<%=session.getAttribute("idg")%>&idt=<%=session.getAttribute("idt")%>"><img src="x.gif" border=0 title="Brisi"></a>
...
function godown22(asd){
top.parent.frames[3].location = "m_template_pdf_framein.jsp?loka="+asd;
return false;
}
...
<td align=center >
Browse page: </td><td>
 <a style="text-decoration:none;color:black"  href="m_templatefunkcija_pdf2.jsp?pagenumber=1<%=iskk%>">first</a></td><td>|</td>
...
%>
<td>
 <a style="text-decoration:none;color:black"  href="m_templatefunkcija_pdf2.jsp?pagenumber=<%=prej%><%=iskk%>">previous</a></td>
...
%>
<td align=center bgcolor="<%=nul.jeNull(session.getValue("pagenumberTemplateFunkcija")+"").equals(ststr+"")?"white":"ededed" %>"> <a hrefs="" style="text-decoration:none;color:black"  href="m_templatefunkcija_pdf2.jsp?pagenumber=<%=ststr %><%=iskk%>"><%=ststr %></a> </td><td>|</td>
<%
...
if (vse!=0) {
	%>
	<td align=center bgcolor="<%=nul.jeNull(session.getValue("pagenumberTemplateFunkcija")+"").equals(ststr+1+"")?"white":"ededed" %>"> <a hrefs="" style="text-decoration:none;color:black"  href="m_templatefunkcija_pdf2.jsp?pagenumber=<%=ststr+1 %><%=iskk%>"><%=ststr+1 %></a> </td><td>|</td>
	<%
...
%>
<td>
 <a style="text-decoration:none;color:black"  href="m_templatefunkcija_pdf2.jsp?pagenumber=<%=prej%><%=iskk%>">next</a></td>
...
<td><a style="text-decoration:none;color:black"  href="m_templatefunkcija_pdf2.jsp?pagenumber=<%=ststr+1%><%=iskk%>">last</a></td>
<td>|</td>
<td >
