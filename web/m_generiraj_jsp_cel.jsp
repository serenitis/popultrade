...
String deploy_kam = parametrii.getParametri().getProperty("deploy_kam");//"E:/Tomcat5.0/webapps/popultrade/";
//String deploy_kam  = "C:/Tomcat5.0/webapps/popultrade/";
...
//public String deploy_kam = "C:/Tomcat5.0/webapps/popultrade/";
...
com.popultrade.model.TemplateMailList tml = sif.getTemplatemaillist();
	...
	sbl.append("outt.append(\"<style type='text/css'>\");\r\n");

	
	sbl.append("outt.append(\"@import 'http://www.popultrade.net/tooltipcss.css';\");\r\n");
	
	sbl.append("outt.append(\"</style>\");\r\n");

	sbl.append("outt.append(\"<script type='text/javascript' language='JavaScript' src='http://www.popultrade.net/tooltip.js'></script>\");\r\n");
	...
	if (!nul.jeNull(tc.getPredpona_pogoja()).equals("VALUE")) {
		sbl.append("}\r\n");
		 ...
		 if (nul.jeNull(tli.getUporabi_onmouseover_prikaz()).equals("1")) {
			 ...
			 hinto = " title='\"+nul.menjajSifrantZnake(nul.jeNull(rezu).replaceAll(\"\'\",\"\").replaceAll(\"\\\"\",\"\").replaceAll(\"&\",\"\").replaceAll(\"\\\\.\",\"\"))+\"'";
	 ...
	 if (!nul.jeNull(tc.getFunkcija_formata1()).equals("") && !nul.jeNull(tc.getFunkcija_formata2()).equals("")) {
        ...
        //	System.out.println("AJAX: ::: "+ajaxpolje);
        	...
        	if (nul.jeNull(tu.getTip_inserta()).equals("hidden")) {
    			...
    			premo = premo + "<input type=\"hidden\" id=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"  name=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+"     value=\"<////%=nul.jeNull(vseb."+tu.getStolpec_metoda()+"()+\"\")%////>\">\r\n";
    			}
			...
			premo = premo + "<input "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+"  readonly type=\"text\" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getParameter_drugo_ime())+"\"  name=\""+nul.jeNull(tu.getParameter_drugo_ime())+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+" value=\"<////%=rezu%////>\" "+dodc+"  style=\"border: 0px solid #D2EAFF;background-color:#D2EAFF;font-family: Verdana; font-size: 8pt;"+(velike_crke.equals("1")?"text-transform:uppercase;":"")+"\" "+ajaxpolje+">\r\n";
        		...
        		premo = premo + "<input type=\"text\"  "+(nul.jeNull(tu.getVnos_kdaj_fiksno()).equals("1")?"readonly":"")+"  "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+"     "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"  name=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+" value=\"<////%=rezu%////>\" "+dodc+"  "+(velike_crke.equals("1")?" class=\"inputIExVC\" ":" class=\"inputIEx\" ")+" "+(ajaxpolje.equals("")?" onfocus=\"ajax_options_hide();change(this,'yellow');\" ":"")+"  onblur=\"change(this,'white');\" "+ajaxpolje+"> <a href=\"javascript: showCalendar('"+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"')\"><img src='call.gif' border='0'></a> \r\n";
        			...
        			if (!nul.jeNull(tu.getParameter_drugo_ime()).trim().equals("")) {
        				premo = premo + "<input type=\"text\" "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getParameter_drugo_ime())+"\"  name=\""+nul.jeNull(tu.getParameter_drugo_ime())+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+"  "+dodc+"  "+(velike_crke.equals("1")?" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"VC\" ":" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"\" ")+" "+(ajaxpolje.equals("")?" onfocus=\"ajax_options_hide();change(this,'yellow');\" ":"")+"  onblur=\"change(this,'white');\"  "+ajaxpolje+"  value=\"<////%=rezu%////>\">\r\n";
            				
        			}
        			else {
        			premo = premo + "<input type=\"text\" "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"  name=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+"  "+dodc+"   "+(velike_crke.equals("1")?" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"VC\" ":" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"\" ")+" "+(ajaxpolje.equals("")?" onfocus=\"ajax_options_hide();change(this,'yellow');\" ":"")+"  onblur=\"change(this,'white');\"  "+ajaxpolje+"  value=\"<////%=nul.jeNull(vseb."+tu.getStolpec_metoda()+"()+\"\")%////>\">\r\n";
        			}
        	...
        	//}
        		...
        		if (nul.jeNull(tu.getVnos_kdaj()).equals("AJ")) {
        			...
        			premo = premo + "<input "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+" type=\"checkbox\" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+(!nul.jeNull(tu.getParameter_drugo_ime()).equals("")?tu.getParameter_drugo_ime().toLowerCase():nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase())+"\" name=\""+(!nul.jeNull(tu.getParameter_drugo_ime()).equals("")?tu.getParameter_drugo_ime().toLowerCase():nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase())+"\"   value=\"1\"  onfocus=\"ajax_options_hide();change(this,'yellow');\" onblur=\"change(this,'white');\" class=\"inputIEx\"  >";
                	
        		}
        		else {
        			premo = premo + "<input "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+" type=\"checkbox\" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\" name=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"  <////%=nul.jeNull(vseb."+tu.getStolpec_metoda()+"()+\"\").equals(\"1\")?\"checked\":\"\"%////>  value=\"1\"  onfocus=\"ajax_options_hide();change(this,'yellow');\" onblur=\"change(this,'white');\" class=\"inputIEx\"   >";
	 ...
	 if (!nul.jeNull(tc.getFunkcija_formata1()).equals("") && !nul.jeNull(tc.getFunkcija_formata2()).equals("")) {
        ...
        //	System.out.println("AJAX: ::: "+ajaxpolje);
			...
			premo = premo + "<input "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+"  readonly type=\""+inum+"\" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getParameter_drugo_ime())+"\"  name=\""+nul.jeNull(tu.getParameter_drugo_ime())+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+" value=\"<////%=rezu%////>\" "+dodc+"  style=\"border: 0px solid #D2EAFF;background-color:#D2EAFF;font-family: Verdana; font-size: 8pt;"+(velike_crke.equals("1")?"text-transform:uppercase;":"")+"\" "+ajaxpolje+">\r\n";
        		...
        		Hashtable metocs = templateUtil.getClassMetodeImenaHTGet(class_name);
        		if (((String)metocs.get(nul.jeNull(tu.getStolpec_metoda()))).indexOf("Date")!=-1) {
        		premo = premo + "<input type=\""+inum+"\"  "+(nul.jeNull(tu.getVnos_kdaj_fiksno()).equals("1")?"readonly":"")+"  "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+"     "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"  name=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+" value=\"<////%=rezu%////>\" "+dodc+"  "+(velike_crke.equals("1")?" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"VC\" ":" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"\" ")+" "+(ajaxpolje.equals("")?" onfocus=\"ajax_options_hide();change(this,'yellow');\" ":"")+"  onblur=\"change(this,'white');\"  "+ajaxpolje+"> <a href=\"javascript: showCalendar('"+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"')\"><img src='call.gif' border='0'></a> \r\n";
        		}
        		else { 
        			...
        			premo = premo + "<input type=\""+inum+"\" "+(nul.jeNull(tu.getVnos_kdaj_fiksno()).equals("1")?"readonly":"")+"  "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"  name=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+" value=\"<////%=rezu%////>\" "+dodc+"  "+(velike_crke.equals("1")?" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"VC\" ":" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"\" ")+" "+(ajaxpolje.equals("")?" onfocus=\"ajax_options_hide();change(this,'yellow');\" ":"")+"  onblur=\"change(this,'white');\"  "+ajaxpolje+">\r\n";
        			}
        		} 
        	}
        	...
        	//}
        		...
        		premo = premo + "<textarea "+(nul.jeNull(tu.getJavascript_event_uporabi()).equals("1")?nul.jeNull(tu.getJavascript_event()):"")+" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\" name=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\" "+(cols.equals("")?"":"cols=\'"+cols+"\'")+" "+(rows.equals("")?"":"rows=\'"+rows+"\'")+"  onfocus=\"ajax_options_hide();change(this,'yellow');\" onblur=\"change(this,'white');\" class=\"inputIEta\" ><////%=rezu%////></textarea>";
        	}
          	else if (nul.jeNull(tu.getTip_inserta()).equals("dropbox")) {
...
sb.append("<script type=\"text/javascript\" language=\"JavaScript\" src=\"js/jquery-1.5.min.js\"></script>\r\n");
...
sb.append("%////>\r\n");
             ...
             sb.append("<td width=\""+tli.getStolpec_width()+"\" align=\""+tli.getStolpec_align()+"\" bgcolor=\""+barv[bar] +"\" < %=dodo%////> onmouseout=\"hideddrivetip()\" onmousemove=\"ddrivetip(p"+tli.getId()+")\">");
             if (nul.jeNull(tli.getStolpec_order()).equals("1")) {
...
/// gumbi
     ...
     while (itbg.hasNext()) {
		 ...
		 if (tli.getTemplateClass()!=null && !nul.jeNull(tli.getTemplateClass().getDodaten_hql_pogoj()).equals("")  && nul.jeNull(tli.getTemplateClass().getDodaten_hql_pogoj()).indexOf("request.getParameter")!=-1) {
			 sb.append("<%\r\n"); 
    	 ...
    	 sb.append("<a href=\"#\" onClick=\""+alert+""+target+targetv.toLowerCase() +"_edit"+upid+predpage+".jsp?opcija=new&siframm=new&sifrant=< %=request.getParameter(\"sifrant\")%////>"+parametri+"'"+(target.indexOf("window")!=-1?")":"")+(!alert.equals("")?":''":"")+";return false;\" href=\"Javascript: PGAPP()\"><img title=\"< %=ConPool.getPrevod(\""+tli.getId()+"P\"+control.getJezik()).replaceAll(\"_\",\" \") %////>\" border=\"0\" src=\"vnos.gif\" /></a>\r\n");
    	
    	 
    	 }
    	 
    	 else if (tli.getUrl_gumba().equals("search.gif") && tli.getLokacija_gumba().equals("H")) {	 
        	 sb.append("<a href=\"#\" onClick=\""+alert+""+target+targetv.toLowerCase() +"_isci.jsp?opcija=new&siframm=new&sifrant=< %=request.getParameter(\"sifrant\")%////>"+parametri+"'"+(target.indexOf("window")!=-1?")":"")+(!alert.equals("")?":''":"")+";return false;\" href=\"Javascript: PGAPP()\"><img title=\"< %=ConPool.getPrevod(\""+tli.getId()+"P\"+control.getJezik()).replaceAll(\"_\",\" \") %////>\" border=\"0\" src=\"search.gif\" /></a>\r\n");
        	 }
    ...
    if (!nul.jeNull(tli.getRocni_url()).trim().equals("")) {
    	if (tli.getTarget_gumba().equals("B")) {
    	 ...
    	 sb.append("<a href=\"#\" onClick=\""+alert+""+target+nul.jeNull(tli.getRocni_url())+"?opcija=new"+parametri+"'"+(target.indexOf("window")!=-1?")":"")+(!alert.equals("")?":''":"")+";return false;\" href=\"Javascript: PGAPP()\"><img title=\"< %=ConPool.getPrevod(\""+tli.getId()+"P\"+control.getJezik()).replaceAll(\"_\",\" \") %////>\" border=\"0\" src=\""+tli.getUrl_gumba()+"\" /></a>\r\n");
		 }	
    }
    else {
    		 if (tli.getTarget_gumba().equals("B")) {
    		 sb.append("<a  href=\"#\"  onclick=\""+target+targetv.toLowerCase() +predpo+".jsp?opcija=new&siframm=new&sifrant=< %=request.getParameter(\"sifrant\")%////>"+parametri+"');return false;\" ><img title=\"< %=ConPool.getPrevod(\""+tli.getId()+"P\"+control.getJezik()).replaceAll(\"_\",\" \") %////>\" border=\"0\" src=\""+tli.getUrl_gumba()+"\" /></a>\r\n");
    			 ...
    			 sb.append("<a href=\"#\" onClick=\""+alert+""+target+targetv.toLowerCase() +predpo+".jsp?opcija=new&siframm=new&sifrant=< %=request.getParameter(\"sifrant\")%////>"+parametri+"'"+(target.indexOf("window")!=-1?")":"")+(!alert.equals("")?":''":"")+";return false;\" href=\"Javascript: PGAPP()\"><img title=\"< %=ConPool.getPrevod(\""+tli.getId()+"P\"+control.getJezik()).replaceAll(\"_\",\" \") %////>\" border=\"0\" src=\""+tli.getUrl_gumba()+"\" /></a>\r\n");
    			 }
    		 }
...
if (sif.getTemplatemaillist()!=null && sif.getTemplatemaillist().getUporabi()!=null && sif.getTemplatemaillist().getUporabi().equals("1")) {
	 ...
	 sb.append("<a href=\"#\" onClick=\""+sif.getTemplatemaillist().getTarget_frame()+"='"+imefile.toLowerCase()+"_ml.jsp"+"?opcija=new&siframm=new&sifrant=f&isk=1';return false;\" href=\"Javascript: PGAPP()\"><img title=\"< %=ConPool.getPrevod(\""+sif.getId()+"K\"+control.getJezik()).replaceAll(\"_\",\" \") %////>\" border=\"0\" src=\""+sif.getTemplatemaillist().getUrl_gumb()+"\" /></a>\r\n");
...
if (!nul.jeNull(tc.getPredpona_pogoja()).equals("VALUE")) {
	sb.append("}\r\n");
	 ...
	 if (nul.jeNull(tli.getStolpec_checkbox()).equals("1")) {
		 sb.append("<td width=\""+tli.getStolpec_width()+"\" align=\""+tli.getStolpec_align()+"\" "+hinto+"><input type='checkbox' value='< %=rezu%////>' name='"+tli.getStolpec_metoda().toLowerCase().replaceAll("get","")+"____< %=rezu%////>'  onfocus=\"ajax_options_hide();change(this,'yellow');\" onblur=\"change(this,'white');\" class=\"inputIEx\" ></td>\r\n");
...
while (itbgd.hasNext()) {
	 ...
	 if (tli.getUrl_gumba().equals("x.gif") && tli.getLokacija_gumba().equals("V") && nul.jeNull(tli.getKlici_funkcijo()).equals("Brisi")) {	 
		 ...
		 sb.append("<a href=\"\" onClick=\""+alert+""+target+targetv.toLowerCase()+"_view"+sif.getId() +".jsp?opcija=spremeni&siframm=new&idback=<////%=vseb.getId()%////>&sifrant=<////%=request.getParameter(\"sifrant\")%////>"+parametri+"'"+(!alert.equals("")?":''":"")+";"+deljs+"return false;\"><img src=\""+urlg+"\" border=0 "+del1+" onClick=\"kliknivSivo(this,'<////%=colors[br]%////>');\" title=\"< %=ConPool.getPrevod(\""+tli.getId()+"P\"+control.getJezik()).replaceAll(\"_\",\" \") %////>\"></a>\r\n");
...
sb.append("%////>\r\n");
sb.append("<td align=center bgcolor=\"<////%=nul.jeNull(session.getValue(\"pagenumber"+imefile+"\")+\"\").equals(ststr+\"\")?\"white\":\"ededed\" %////>\"> <a hrefs=\"\" style=\"text-decoration:none;color:black\"  href=\""+imefile.toLowerCase()+"_list"+sif.getId()+".jsp?pagenumber=<////%=prvii %////><////%=iskk%////>\"><////%=prvii %////></a> </td><td>|</td>\r\n");
sb.append("<////%\r\n");
...
if (nul.jeNull(tu.getTip_inserta()).equals("textbox")) {
	...
	if (((String)metocs.get(nul.jeNull(tu.getStolpec_metoda()))).indexOf("Date")!=-1) {
		pp.append("<input type=\"text\" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"  name=\""+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+"    onfocus=\"ajax_options_hide();change(this,'yellow');\" onblur=\"change(this,'white');\" class=\"inputIEx\"  > <a href=\"javascript: showCalendar('"+nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase()+"')\" value=\"\" ><img src='call.gif' border='0'></a> \r\n");
		}
		else {	

pp.append("<input type=\"text\" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+(!nul.jeNull(tu.getRazlicno_ime_inputa()).equals("")?nul.jeNull(tu.getRazlicno_ime_inputa()):nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase())+"\"  name=\""+(!nul.jeNull(tu.getRazlicno_ime_inputa()).equals("")?nul.jeNull(tu.getRazlicno_ime_inputa()):nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase())+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+" value=\"<////%=rezu%////>\"  onfocus=\"ajax_options_hide();change(this,'yellow');\" onblur=\"change(this,'white');\" class=\"inputIEx\"  >\r\n");
}
}
else if (nul.jeNull(tu.getTip_inserta()).equals("checkbox")) {
	/// nujno dodati v insert pogoje
	pp.append("<input type=\"checkbox\" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+(!nul.jeNull(tu.getRazlicno_ime_inputa()).equals("")?nul.jeNull(tu.getRazlicno_ime_inputa()):nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase())+"\" name=\""+(!nul.jeNull(tu.getRazlicno_ime_inputa()).equals("")?nul.jeNull(tu.getRazlicno_ime_inputa()):nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase())+"\"  <////%=nul.jeNull(vseb."+tu.getStolpec_metoda()+"()).equals(\"1\")?\"checked\":\"\"%////>  value=\"1\"  onfocus=\"ajax_options_hide();change(this,'yellow');\" onblur=\"change(this,'white');\" class=\"inputIEx\" >\r\n");
}
	else if (nul.jeNull(tu.getTip_inserta()).equals("textarea")) {
	/// nujno dodati v insert pogoje
	String cols = nul.jeNull(tu.getCols());
...
sb.append("function KeyCheckMouse()");
sb.append("{\r\n");
...
sb.append("document.onkeyup = KeyCheck;\r\n");       
...
pp.append("<input type=\"text\" "+(tabi.equals("")?"":"tabindex=\'"+tabi+"\'")+" id=\""+(!nul.jeNull(tu.getRazlicno_ime_inputa()).equals("")?nul.jeNull(tu.getRazlicno_ime_inputa()):nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase())+"\"  name=\""+(!nul.jeNull(tu.getRazlicno_ime_inputa()).equals("")?nul.jeNull(tu.getRazlicno_ime_inputa()):nul.jeNull(tu.getStolpec_metoda()).replaceAll("get","").toLowerCase())+"\"   "+(max.equals("")?"":"maxlength=\'"+max+"\'")+" "+(dol.equals("")?"":"size=\'"+dol+"\'")+" value=\"<////%=rezu%////>\"  "+(!ajaxpolje.equals("")?" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"\" ":" class=\"inputIEx"+(!ajaxpolje.equals("")?"a":"")+"\" ")+" "+(ajaxpolje.equals("")?" onfocus=\"ajax_options_hide();change(this,'yellow');\" ":"")+"  onblur=\"change(this,'white');\"  "+ajaxpolje+">\r\n");
}
}
else if (nul.jeNull(tu.getTip_inserta()).equals("password")) {
	/// nujno dodati v insert pogoje
...
sb.append("<form name=\"dod\" method=\"post\" action=\""+imefile.toLowerCase()+"_list"+tgumbb.getTemplatehead_id()+".jsp\" target=\"ifr2\" onSubmit=\"return subm()\">\r\n");
	...
	while (true) {
		...
		if (itmo.hasNext()) {
			...
			if (nul.jeNull(tu.getTip_polja()).equals("PR")) {
				...
				sb.append(genFieldSE(tu,nul,templateUtil,contextUtil,pageContext.getServletContext(),false,sif.getHead_class_name()));
		        ...
		        while (nexc.hasNext()) {
		        	...
		        	sb.append(" < %=ConPool.getPrevod(\""+tuinext.getId()+"P\"+control.getJezik()).replaceAll(\"_\",\" \") %////> ");
		        	sb.append(genFieldSE(tuinext,nul,templateUtil,contextUtil,pageContext.getServletContext(),true,sif.getHead_class_name()));
