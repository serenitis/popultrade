...
<form name=dod action="m_templatefunkcijastart_edit.jsp" method="post" onSubmit="return check()">
...
<tr>
            		 <td class="opiscell" width="20%">Zaporeje (zaporedje klicanja funkcij): </td><td class="valuecell"  colspan=3>
