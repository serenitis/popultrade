...
<form name="dod" action="m_templateview_pdf.jsp?idt=<%=request.getParameter("idt")%>&akcija=prevod" method="post">
...
<%
	...
	<a href="Javascript:PGAPP()" onCLick="return godown('m_templateclass_pogoj_pdf_framein.jsp?idg=<%=vseb.getId()%>&opcija=spremeni&siframm=new&idtf=<%=vseb.getId()%>&sifid=<%=vseb.getId()%>&idt=<%=request.getParameter("idt")%>&idnn=<%=request.getParameter("idnn")%>')"><img src="pp.gif" alt="Pogoji prikaza vrednosti" border=0></a>
	
		<a href="Javascript:PGAPP()" onCLick="return godown('m_templateuidodatno_edit_pdf.jsp?opcija=new&siframm=new&sifrant=null&idt=<%=vseb.getId()%>')"><img src="dro.gif" alt="Rocni vnos pogojev in funkcij" border=0></a>
	 ...
	 <br><a onClick="return vprasaj()" href="m_templateview_pdf.jsp?akcija=DELETE&id=<%=vseb.getId()%>&idt=<%=request.getParameter("idt")%>"><img src="x.gif" border=0 title="Brisi"></a>
...
%>
	...
	<a href="Javascript:PGAPP()" onCLick="return godown('m_templateclass_pogoj_pdf_framein.jsp?idg=<%=vsebb.getId()%>&opcija=spremeni&siframm=new&idtf=<%=vsebb.getId()%>&sifid=<%=vseb.getId()%>&idt=<%=request.getParameter("idt")%>&idnn=<%=request.getParameter("idnn")%>')"><img src="pp.gif" alt="Pogoji prikaza vrednosti" border=0></a>
			<a href="Javascript:PGAPP()" onCLick="return godown('m_templateuidodatno_edit_pdf.jsp?opcija=new&siframm=new&sifrant=null&idt=<%=vsebb.getId()%>')"><img src="dro.gif" alt="Rocni vnos pogojev in funkcij" border=0></a>
	</td>
	...
	<a onClick="return vprasaj()" href="m_templateview_pdf.jsp?akcija=DELETE&id=<%=vsebb.getId()%>&idt=<%=request.getParameter("idt")%>"><img src="x.gif" border=0 title="Brisi"></a>
...
%>
	...
	<tr><td colspan=6 >
	<a onClick="return godown('m_templateview_pdf_edit.jsp?opcija=new&siframm=new&sifrant=null&idt=<%=request.getParameter("idt")%>&idn=<%=vseb.getId()%>')" href="Javascript: PGAPP()"><img title="Dodaj v isto polje" border="0" src="next.gif" /></a>
	</td></tr>
	</table> 
	</td>
...
<td class="opiscell" width="20%">&nbsp;</td><td class="valuecell" width="30%">
	<a onClick="return godown('m_templateview_pdf_edit.jsp?opcija=new&siframm=new&sifrant=null&idt=<%=request.getParameter("idt")%>')" href="Javascript: PGAPP()"><img title="Dodaj novo polje" border="0" src="vnos.gif" /></a> &nbsp;
...
%>
 ...
 <tr><td colspan=4 align=center bgcolor=silver height=32>
  ...
  <input type="button" value="Dodaj parametre za format izpisa" onCLick="return godown('m_templatepdfparametri_edit.jsp?idt=<%=request.getParameter("idt")%>')" style="font-family: Verdana; font-size: 8pt"><br>
...
function go(asd,vv){
  if (vv == 1){
    aaa = "m_templateview_pdf_edit.jsp?id="+asd;
