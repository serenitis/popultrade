...
<form name=dod action="m_templatelist_edit.jsp" method="post" onSubmit="return check()">
...
com.popultrade.dao.TemplateHeadDAO daoth = (com.popultrade.dao.TemplateHeadDAO)contextUtil.getBeanDao("templateHeadDAO",pageContext.getServletContext());
 ...
 <input type="checkbox" name="stolpec_checkbox" value="1" <%=nul.jeNull(vseb.getStolpec_checkbox()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
		 V primeru da zelimo izbrati vec recordov hkrati se doda checkbox stolpec. Vrednost v Stolpec metoda se poda kot parameter za nadaljno obdelavo (podobno kot parametri preko gumba). Pri kreaciji gumba je treba oznacit , da dobi parametre preko checkboxa ter ime iz Stolpec metoda.
            	...
            	<br>Ce se rabi PP gumb se checkbox ne doda avtomaticno (za rocni checkbox ime uporabi: |ime stolpca v bazi|+____+|rezu| -- rezu je vrednost stolpca )
            		 </td>
...
com.popultrade.dao.TemplateHeadDAO daoth = (com.popultrade.dao.TemplateHeadDAO)contextUtil.getBeanDao("templateHeadDAO",pageContext.getServletContext());
					...
					List lie = daoth.getTemplateHeads(thead, 1, 100, "", "", "");
					
					Iterator itti = lie.iterator();
...
<input type="text" name="slika_height"   maxlength='4' size="4" value="<%=nul.jeNull(vseb.getSlika_height()+"")%>" style="font-family: Verdana; font-size: 8pt">
            		 ...
            		 <td class="opiscell" width="20%">Uporabi vrednost kot hint: </td><td class="valuecell" colspan="3">
 <input type="checkbox" name="uporabi_onmouseover_prikaz" value="1" <%=nul.jeNull(vseb.getUporabi_onmouseover_prikaz()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
			 (prikaze se v okencu hint ko gres z misko gor, pod gumbom pp je potrebno definirat vrednost iz druge classe)	            		 
            		 ...
            		 <td class="opiscell" width="20%">Ob kliku na stolpec uporabi order by po stolpcu: </td><td class="valuecell" colspan="3">
 <input type="checkbox" name="stolpec_order" value="1" <%=nul.jeNull(vseb.getStolpec_order()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
            		 ...
            		 <td class="opiscell" width="20%">Stolpec prikazi po defaultu: </td><td class="valuecell" >
 <input type="checkbox" name="stolpec_primaren" value="1" <%=(vseb.getId()==null || nul.jeNull(vseb.getStolpec_primaren()+"").equals("1"))?"checked":""%> style="font-family: Verdana; font-size: 8pt">
	Stolpec ne moras odstranit: <input type="checkbox" name="stolpec_fiksen" value="1" <%=nul.jeNull(vseb.getStolpec_fiksen()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
			            		 
      		 	 
            		 </td>
	  
            		 <td class="opiscell" width="20%">Stolpec lahko dodas ob kliku na desni gumb: </td><td class="valuecell">
 <input type="checkbox" name="stolpec_sekundaren" value="1" <%=nul.jeNull(vseb.getStolpec_sekundaren()+"").equals("1")?"checked":""%> style="font-family: Verdana; font-size: 8pt">
